...
namespace BaseSet
{
    ...
    /// 資料庫Class
    /// </summary>
    public class ClassDB_MariaDB
    {
        /// <summary>
        /// 資料庫Class
        /// </summary>
        /// <param name="strConnectionString">SQL連線字串</param>
        public ClassDB_MariaDB(string strConnectionString)
        {
            ...
            if (!string.IsNullOrEmpty(strConn))
                oldbcn = new MySqlConnection(strConn);
        }
        ...
        /// Ole Db Connection
        /// </summary>
        public MySqlConnection oldbcn  { get; set; }
        ...
        public DataTable GetData(string strSql)
        {
            ...
            MySqlCommand oldbcm = new MySqlCommand();
            oldbcm.Connection = oldbcn;
            oldbcm.CommandType = CommandType.Text;
            oldbcm.CommandText = strSql;

            MySqlDataAdapter oldba = new MySqlDataAdapter(oldbcm);
        ...
        public bool UpdData(string strSql)
        {
            ...
            MySqlTransaction oldbTran = null;
        ...
        /// <returns></returns>
        public bool UpdData(string strSql, MySqlConnection I_oldbcn, MySqlTransaction I_oldbTran)
        {
            MySqlCommand oldbcm = new MySqlCommand();
            oldbcm.CommandType = CommandType.Text;
            try
        ...
        {
            //MySql連線
            MySqlConnection oConnection = new MySqlConnection(strConn);
            //資料橋接器
            MySqlDataAdapter oDataAdapter = new MySqlDataAdapter();
            oDataAdapter.SelectCommand = new MySqlCommand(strSelectSql, oConnection);
            //SQL Command產生器
            MySqlCommandBuilder oCommandBuilder = new MySqlCommandBuilder(oDataAdapter);
            //Trans
            MySqlTransaction oldbTran = null;
            //Command
            MySqlCommand oldbcm = new MySqlCommand();
        ...
        /// <param name="strSql">Sql Command</param>
        /// <returns></returns>
        public bool UpdData(DataTable UpdateDT, MySqlDataAdapter oDataAdapter)
        {
            MySqlConnection oConnection = oDataAdapter.SelectCommand.Connection;
        ...
        public DataTable GetSchema(string strSql)
        {
            ...
            MySqlDataAdapter oDataAdapter = new MySqlDataAdapter();
            //SQL Command產生器
            MySqlCommandBuilder oCommandBuilder = new MySqlCommandBuilder();
            oDataAdapter.SelectCommand = new MySqlCommand(strSql, oldbcn);
        ...
        /// <returns></returns>
        public bool RunProcedure(string ProcedureName, params MySqlParameter[] oParam)
        {
            oldbcn = new MySqlConnection(strConn);
            MySqlCommand oldbcm = new MySqlCommand();
            oldbcm = oldbcn.CreateCommand();
            ...
            if (oParam != null)
            {
                foreach (MySqlParameter myParam in oParam)
                {
        ...
        public void DataTableToExcel(DataTable dt, string connString)
        {
            ...
            using (MySqlConnection objConn = new MySqlConnection(connString))
            {
                ...
                //建立插入動作的Command
                objCmd.CommandText = sb.ToString();
                MySqlParameterCollection param = objCmd.Parameters;

                for (int i = 0; i < cols; i++)
                {
                    param.Add(new MySqlParameter("@" + dt.Columns[i].ColumnName, MySqlDbType.VarChar));
                }
